...
abstract class AppLocalizations {
  ...
  /// No description provided for @inputUsernamePassword.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @anotherDeviceDetected.
  ///
  /// In en, this message translates to:
  /// **'You just logged in on another [%s] device.'**
  String get anotherDeviceDetected;

  /// No description provided for @doYouWantRelogin.
  ///
  /// In en, this message translates to:
  /// **'Do you want to re-login ?'**
  String get doYouWantRelogin;
}
